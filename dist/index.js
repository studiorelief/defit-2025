...
(() => {
  ...
  // src/utils/animations/animationLoad.ts
  ...
  // src/utils/animations/heroTextLoop.ts
  function swiperCrossfade() {
  ...
  function replaceHeroHeadings() {
    ...
    heroHeadings.forEach((heroHeading, index) => {
      ...
      if (replacer) {
        ...
        replacer.style.top = "0";
        replacer.style.left = "0";
        replacer.style.height = "100%";
        heroHeading.appendChild(replacer);
      }
    });
  }

  // src/utils/animations/iconsLoop.ts
  function iconsLoop() {
  ...
  // src/utils/animations/wearablesLoop.ts
  var wearablesLoop = () => {
  ...
  function navbarMobile() {
    ...
    if (isMobile) {
      const modal = document.querySelector(".navbar_menu-wrapper");
      const overlay = document.querySelector(".navbar_menu-layer");
